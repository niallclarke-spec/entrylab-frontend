      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative hidden lg:flex justify-center">
            ...
            <div className="absolute -bottom-4 left-0 xl:left-[22px] hidden xl:flex items-center gap-3 px-4 py-3 rounded-xl bg-[#1a2420]/80 backdrop-blur-sm border border-[#2bb32a]/30">
