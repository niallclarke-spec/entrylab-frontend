 ...
 * Plugin URI: https://entrylab.io
 * Description: Newsletter subscription system for EntryLab - stores subscribers in database with admin management interface
 * Version: 1.0.0
 * Author: EntryLab
 * Text Domain: entrylab-newsletter
 */
